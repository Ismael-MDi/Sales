...
import com.itvo.sales.domain.usecase.product.CreateProductUseCase
import dagger.hilt.android.lifecycle.HiltViewModel
import javax.inject.Inject // OJO: Usualmente es javax.inject.Inject en Hilt, no jakarta
...
class CreateProductViewModel @Inject constructor(
    ...
    private fun saveProduct() {
        ...
        viewModelScope.launch {
            ...
            try {
                // Aquí estaba el error principal: faltaban los () en las conversiones
                val product = Product(
                    code = currentState.code,
                    description = currentState.description,
                    category = currentState.category,
                    price = currentState.price.toDoubleOrNull() ?: 0.0, // ¡Corregido!
                    stock = currentState.stock.toIntOrNull() ?: 0,      // ¡Corregido!
